...
def seed(apps, schema_editor):
    ...
    # Review(doctor=doctor1, name='Susie', description='The vet was great but I waited so long for my appointment', overall_rating='4',
    #        bed_side_rating='5', wait_time_rating='2', created_at='2017-09-26 11:01:20.547000').save()

    # Review(doctor=doctor2, name='Ana',
    #        description='This place is amazing it has an assortment of pet retail products, pet care services and amazing staff. My little nova cannot get enough of it', overall_rating='3', bed_side_rating='4', wait_time_rating='4', created_at='2017-09-26 11:01:20.547000').save()
